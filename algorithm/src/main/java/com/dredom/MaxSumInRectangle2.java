...
//    };
    ...
    public static void main(String[] args) {
        ...
        MaxSumInRectangle2 instance = new MaxSumInRectangle2();
    ...
    public int findMax(int[][] array) {
        ...
        while (y < dim) {
            ...
            while (y2 <= dim) {
                ...
                while (x < dim) {
                    int x2 = x + 1;
                    // Initialize to zero as we advance the y-axis start row.
                    int ysum = 0;
                    if ((x > 0 || y > 0) || (y2 < dim || x2 < dim)) {
                        // Sum of left hand column
                        ysum = sumArray(array, y, x, y2, x2 -1);
                    }
                    while (x2 <= dim) {
